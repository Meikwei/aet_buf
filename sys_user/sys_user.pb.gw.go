...
func request_SysUser_ListByIDs_0(ctx context.Context, marshaler runtime.Marshaler, client SysUserClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListSysUserByIDsRequest
	var metadata runtime.ServerMetadata
...
func request_SysUser_ListByLastID_0(ctx context.Context, marshaler runtime.Marshaler, client SysUserClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListSysUserByLastIDRequest
	var metadata runtime.ServerMetadata
...
func request_SysUser_List_0(ctx context.Context, marshaler runtime.Marshaler, client SysUserClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_SysUser_List_0(ctx context.Context, marshaler runtime.Marshaler, server SysUserServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ListSysUserRequest
	var metadata runtime.ServerMetadata
...
func RegisterSysUserHandlerServer(ctx context.Context, mux *runtime.ServeMux, server SysUserServer) error {
	...
	mux.Handle("POST", pattern_SysUser_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/aet_buf.sys_user.SysUser/List", runtime.WithHTTPPathPattern("/v1/sys_user/list"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_SysUser_List_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		md.HeaderMD, md.TrailerMD = metadata.Join(md.HeaderMD, stream.Header()), metadata.Join(md.TrailerMD, stream.Trailer())
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
		...
		forward_SysUser_List_0(annotatedContext, mux, outboundMarshaler, w, req, resp, mux.GetForwardResponseOptions()...)
...
func RegisterSysUserHandlerClient(ctx context.Context, mux *runtime.ServeMux, client SysUserClient) error {
	...
	mux.Handle("POST", pattern_SysUser_List_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/aet_buf.sys_user.SysUser/List", runtime.WithHTTPPathPattern("/v1/sys_user/list"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_SysUser_List_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
...
var (
	...
	pattern_SysUser_List_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"v1", "sys_user", "list"}, ""))
)
...
var (
	...
	forward_SysUser_List_0 = runtime.ForwardResponseMessage
)
